function randomCharacterGenerator() {
    ...
    characterName.innerHTML = '<img src="bb8loading.gif">'
    birthYear.innerHTML = '<img src="bb8loading.gif">'
    hairColor.innerHTML = '<img src="bb8loading.gif">'
    eyeColor.innerHTML = '<img src="bb8loading.gif">'
    planet.innerHTML = '<img src="bb8loading.gif">'
